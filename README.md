...
### 1. Extension 팝업 UI
![Extension 팝업](./img/feature01.png)
*Extension 아이콘을 클릭하면 나타나는 팝업 UI*
...
### 2. 전체 페이지 번역
![전체 페이지 번역](./img/feature02.png)
*웹 페이지 전체를 한글로 번역*

- "번역" 버튼 클릭으로 페이지 전체 번역
- 원본 레이아웃 유지
- 번역 진행 상태 표시

### 3. 선택 영역 번역 (Context Menu)
![선택 영역 번역](./img/feature03.png)
*텍스트 선택 후 오른쪽 클릭으로 빠른 번역*
...
### 4. 설정 페이지
![설정 페이지](./img/feature04.png)
*Amazon Bedrock API Key 설정*
...
5. 5초 후 자동 숨김 또는 외부 클릭/닫기 버튼으로 수동 닫기
